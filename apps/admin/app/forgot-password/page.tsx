      ...
      <Card className="w-full max-w-md bg-gray-800 border-gray-700 shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex">
                ...
                />
                <span className="flex items-center px-3 text-gray-400 bg-gray-600 rounded-r-md">
                  @gachon.ac.kr
                </span>
              </div>
            </div>
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <Link
              href="/login"
              className="flex items-center justify-center text-sm text-gray-400 hover:text-blue-400"
            >
